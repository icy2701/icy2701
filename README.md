# Aisiri Mallekoppa Ramachandra

Software engineer with 2.5 years at Oracle Financial Services in data engineering, ETL pipelines, and ML-based anomaly detection on multi-terabyte financial datasets. 
Background in Information Science and Engineering (CGPA 8.86, First Class with Distinction).

Incoming MSc Computer Science student at RPTU Kaiserslautern-Landau.
...
**Associate Consultant, Oracle Financial Services** (Jul 2023 to Present)
...
Python · SQL · PL/SQL · LangChain · FAISS · FastAPI · Streamlit · Docker · GitHub Actions · Groq API · scikit-learn · TensorFlow · OFSAA · OBIEE · SQLite · Git

---

## Currently

Preparing for MSc CS at RPTU Kaiserslautern-Landau. Studying DSA, ML fundamentals, and German (A2). Building AI projects in the meantime.

📫 aisirimr@gmail.com · [LinkedIn](https://linkedin.com/in/aisiri-m-r)
